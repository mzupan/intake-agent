...
#
# some edits done by ServerPlot team to make it mirror the loads and dumps functions of the 
# json module
#
...
def dumps(obj, encoding="utf-8",stripWhiteSpace=alwaysStripWhiteSpace):
